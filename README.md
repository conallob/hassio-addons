...
---
### [Calibre-Web Automated](https://github.com/conallob/hassio-addons/tree/master/calibre-web-automated)

**Version**: 4.0.6

Automated Calibre-Web ebook library manager with ingest-folder monitoring, format conversion and metadata enforcement
...
**Version**: 0.0.21  **Image**: external (`ghcr.io/conallob/hassio-obsidian-headless`)
...
---
### [OmniFocus Sync MCP](https://github.com/conallob/hassio-addons/tree/master/omnifocus-sync-mcp)

**Version**: 0.4.0

HTTP interface to a Model Context Protocol server for OmniFocus, synced via Omni Sync Server (no Mac or OmniFocus app required)
